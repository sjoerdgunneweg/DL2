...
def get_stored_demo(data_path, index):
  ...
  for i in range(num_steps):
    ...
    obs[i].left_shoulder_depth = image_to_float_array(Image.open(get_depth_img_path(CAMERA_LS, i, episode_path)), DEPTH_SCALE)
    ...
    obs[i].right_shoulder_depth = image_to_float_array(Image.open(get_depth_img_path(CAMERA_RS, i, episode_path)), DEPTH_SCALE)
    ...
    obs[i].wrist_depth = image_to_float_array(Image.open(get_depth_img_path(CAMERA_WRIST, i, episode_path)), DEPTH_SCALE)
